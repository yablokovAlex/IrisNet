"""
Django settings for IrisNet project.
...
SECRET_KEY = 'k=!^bdh7#q^h36o+zs2it7gt6t7rm_m^8960y=hc4f4nh!4zh1'
...
'''
TEMPLATES_DIRS = (
    'C:/Users/user/PycharmProjects/IrisNet/templates'
)
'''
...
WSGI_APPLICATION = 'IrisNet.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'irisnet_db.sqlite3'),
    }
}
...
STATICFILES_DIRS = [
    ...
    '/Users/user/PycharmProjects/IrisNet/static',
]
